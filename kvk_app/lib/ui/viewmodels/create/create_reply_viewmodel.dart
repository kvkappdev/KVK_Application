...
final log = getLogger("Create Reply View Model");

class CreateReplyViewModel extends KVKViewModel {
  ...
  Future submitReply(
    ...
    _databaseService.createReplyToPost(
  ...
  Future<bool> onBackPressed({@required ScreenArguments args}) async {
    await _navigationService
        .pushNamedAndRemoveUntil(Routes.viewPostView, arguments: args.oldArgs)
        .whenComplete(() {
      return true;
    });
    return false;
