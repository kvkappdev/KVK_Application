...
import 'package:kvk_app/ui/viewmodels/create/create_announcement_viewmodel.dart';
import 'package:sliding_up_panel/sliding_up_panel.dart';
import 'package:stacked/stacked.dart';
import 'package:video_player/video_player.dart';

final log = getLogger("Create Announcement View");
...
class CreateAnnouncementView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<CreateAnnouncementViewModel>.reactive(
      ...
      viewModelBuilder: () => CreateAnnouncementViewModel(),
    );
  }
}

Widget attachedFiles(
    {@required CreateAnnouncementViewModel model,
...
Widget fileType(
    {@required CreateAnnouncementViewModel model, @required int index}) {
...
Widget bodyInput(
    {@required CreateAnnouncementViewModel model, @required double width}) {
  return Container(
    ...
    child: TextField(
      ...
      decoration: InputDecoration(
          ...
          hintText: model.lang().createAnnouncementPrompt,
          hintStyle: TextStyle(
  ...
  return Container(
    ...
    child: Row(
      ...
      children: <Widget>[
        ...
        Container(
          margin: new EdgeInsets.only(right: width * 0.05),
          child: Text(
            model.lang().createAnnouncement,
            style: TextStyle(
              fontFamily: "Lato",
              fontSize: 20,
              height: 0.83,
        ...
        submitButton(context: context, height: height, model: model),
      ],
    ),
  );
}
