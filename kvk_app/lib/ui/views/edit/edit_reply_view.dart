...
import 'package:kvk_app/ui/viewmodels/edit/edit_reply_viewmodel.dart';
import 'package:sliding_up_panel/sliding_up_panel.dart';
import 'package:stacked/stacked.dart';
import 'package:video_player/video_player.dart';

final log = getLogger("Edit Reply View");
final fileExtensionRegex = new RegExp(r"\.(?:.(?!\.))+$");

class EditReplyView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<EditReplyViewModel>.reactive(
      ...
      viewModelBuilder: () => EditReplyViewModel(),
    );
  }
}

Widget attachedFiles(
    {@required EditReplyViewModel model,
...
Widget fileType({@required EditReplyViewModel model, @required int index}) {
...
Widget bodyInput({@required EditReplyViewModel model, @required double width}) {
  return Container(
...
Widget userDetails(
  ...
  return Container(
    ...
    child: Row(
      children: <Widget>[
        model.getProfilePic(userId: args.reply.userId) != null
            ? CircleAvatar(
                backgroundColor: Colors.transparent,
                backgroundImage:
                    model.getProfilePic(userId: args.reply.userId).image,
                radius: width * 0.1,
              )
            : CircleAvatar(
                backgroundColor: Colors.transparent,
        ...
        Container(
          ...
          child: Text(
            model.getName(userId: args.reply.userId) != ""
                ? model.getName(userId: args.reply.userId)
...
Widget crossButton(
    {@required double width, @required EditReplyViewModel model}) {
  return Container(
    child: RCrossButton(
      size: width * 0.1,
      color: Colour.kvk_white,
