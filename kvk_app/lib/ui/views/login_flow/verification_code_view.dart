...
import 'package:kvk_app/ui/viewmodels/login_flow/verification_code_viewmodel.dart';
import 'package:kvk_app/ui/smart_widgets/pin_text_field.dart';
import 'package:stacked/stacked.dart';

final log = getLogger('Verification-Code-View');
...
class VerificationCodeView extends StatelessWidget {
  ...
  /// Last Updated: 8/09/2020
  Widget resendCode(
      {@required VerificationCodeViewModel model,
  ...
  /// Last Updated: 8/09/2020
  Widget backButton(
      {@required double width, @required VerificationCodeViewModel model}) {
    return Container(
  ...
  /// Initial creation: 8/09/2020
  /// Last Updated: 8/09/2020
  Widget verificationTitle(VerificationCodeViewModel model) {
    return Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: <Widget>[
          Text(
            model.lang().verificationTitle,
            style: TextStyle(
                color: Colour.kvk_white,
                fontFamily: "Lato",
                fontSize: 24,
  ...
  /// Initial creation: 8/09/2020
  /// Last Updated: 8/09/2020
  Widget verificationMsg(VerificationCodeViewModel model) {
