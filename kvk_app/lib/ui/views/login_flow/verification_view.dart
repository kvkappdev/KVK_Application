...
import 'package:kvk_app/ui/viewmodels/login_flow/verification_viewmodel.dart';
...
class VerificationView extends StatelessWidget {
  ...
  Widget error({
    ...
    @required VerificationViewModel model,
  }) {
    return Container(
  ...
  Widget backButton(
    ...
    return Container(
      ...
      child: RBackButton(
        ...
        onPressed: () {
          model.onBackPressed();
          // model.back(routeName: Routes.homeView);
        },
      ),
    );
  }
  ...
  /// Initial creation: 8/09/2020
  /// Last Updated: 8/09/2020
  Widget verificationTitle(VerificationViewModel model) {
    return Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: <Widget>[
          Text(
  ...
  Widget dropDownCallingCode(
      {@required VerificationViewModel model, @required BuildContext context}) {
    return Container(
  ...
  /// Initial creation: 8/09/2020
  /// Last Updated: 8/09/2020
  Widget verificationMsg(VerificationViewModel model) {
