...
/// This class is taken from the github repository below.
/// It has been converted to work as is required in this application. For more information see:
/// https://gist.github.com/DhytoDev/cdadf2e78bd694192c65b5634c2ad53e
...
class _DropdownMenuRouteLayout<T> extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    ...
    final double width = math.min(constraints.maxWidth, buttonRect.width - 20);
  ...
  Offset getPositionForChild(Size size, Size childSize) {
    ...
    return new Offset(left + 5, menuTop);
  }
...
class _DropdownRoute<T> extends PopupRoute<_DropdownRouteResult<T>> {
  ...
  Widget buildPage(BuildContext context, Animation<double> animation,
    ...
    double menuTop = (buttonTop - selectedItemOffset) -
        (_kMenuItemHeight - buttonRect.height) +
        10 / 2.0;
...
//    _updateSelectedIndex();
  ...
  Icon getIcon() {
    return new Icon(Icons.arrow_drop_down,
        size: widget.iconSize, color: Colour.kvk_grey);
  }
}
